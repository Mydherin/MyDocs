...
- Backend guidelines | Read it **ALWAYS** that you are going to modify the backend part | `harness/techguide/backend-guidelines.md`
- Dev deploy | Read it when you need to start, stop, restart or check status of the whole system in dev mode | `harness/techguide/dev-deploy/dev-deploy.md`
